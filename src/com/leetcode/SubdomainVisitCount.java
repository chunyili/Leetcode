 ...
 * "discuss.leetcode.com". When we visit a domain like "discuss.leetcode.com", we will also visit the parent domains "leetcode.com"
 * and "com" implicitly.
 *
...
public class SubdomainVisitCount {
    ...
    public List<String> subdomainVisits(String[] cpdomains) {
        ...
        for (String d : cpdomains) {
            ...
            int index = cur[1].indexOf(".");

            String key = cur[1];
            map.put(cur[1], map.getOrDefault(cur[1], 0) + val);
...
//Note, need to add value which get from cur[0]
